...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/Util/CustomFormatter.php';
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7XU9lrU82A', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $b->pushHandler(($container->privates['monolog.handler.doctrine'] ?? self::getMonolog_Handler_DoctrineService($container)));
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AttributeDriver($container->parameters['api_platform.resource_class_directories'], false), 'App\\Entity');
    ...
    {
        return $container->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wIRohzt1qc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eyF5gdk6mB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZUwntoa1Nz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IogCNei1kI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wNQBdWthB8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getApiPlatform_Identifier_ConverterService($container)
    {
        return $container->privates['api_platform.identifier.converter'] = new \ApiPlatform\Core\Identifier\IdentifierConverter(($container->privates['api_platform.identifiers_extractor.cached'] ?? self::getApiPlatform_IdentifiersExtractor_CachedService($container)), ($container->privates['api_platform.metadata.property.metadata_factory.cached.legacy'] ?? self::getApiPlatform_Metadata_Property_MetadataFactory_Cached_LegacyService($container)), new RewindableGenerator(function () use ($container) {
            ...
            yield 1 => ($container->privates['api_platform.identifier.date_normalizer'] ??= new \ApiPlatform\Core\Identifier\Normalizer\DateTimeIdentifierDenormalizer());
        }, 2));
    }
    ...
    {
        return $container->privates['api_platform.metadata.property.name_collection_factory.cached'] = new \ApiPlatform\Metadata\Property\Factory\CachedPropertyNameCollectionFactory(($container->privates['api_platform.cache.metadata.property.legacy'] ?? self::getApiPlatform_Cache_Metadata_Property_LegacyService($container)), new \ApiPlatform\Metadata\Property\Factory\ExtractorPropertyNameCollectionFactory(($container->privates['api_platform.metadata.extractor.xml.legacy'] ??= new \ApiPlatform\Core\Metadata\Extractor\XmlExtractor([], $container)), new \ApiPlatform\Metadata\Property\Factory\PropertyInfoPropertyNameCollectionFactory(($container->privates['property_info'] ?? self::getPropertyInfoService($container)))));
    }
    ...
    {
        return $container->privates['api_platform.operation_path_resolver.router'] = new \ApiPlatform\Core\Bridge\Symfony\Routing\RouterOperationPathResolver(($container->privates['api_platform.router'] ?? self::getApiPlatform_RouterService($container)), ($container->privates['api_platform.operation_path_resolver.custom'] ?? self::getApiPlatform_OperationPathResolver_CustomService($container)), ($container->privates['api_platform.subresource_operation_factory.cached'] ?? self::getApiPlatform_SubresourceOperationFactory_CachedService($container)));
    }
    ...
    {
        return $container->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pJGprXVtVj', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T3yd2yPwFV', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
     ...
     */
    protected static function getMonolog_Handler_DoctrineService($container)
    {
        $container->privates['monolog.handler.doctrine'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/doctrine.log'), 'info', true, NULL, false);

        $instance->pushProcessor(($container->privates['monolog.processor.psr_log_message'] ??= new \Monolog\Processor\PsrLogMessageProcessor()));
        $instance->setFormatter(($container->privates['memory.custom-formatter'] ??= new \App\Util\CustomFormatter()));
    ...
    {
        $container->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/dev.log'), 10, 'info', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.routes' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_RoutesService($container)
    {
        $container->privates['monolog.handler.routes'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/request.log'), 'info', true, NULL, false);
    ...
    protected static function getMonolog_Logger_RequestService($container)
    {
        ...
        $instance->pushHandler(($container->privates['monolog.handler.error'] ?? self::getMonolog_Handler_ErrorService($container)));
        $instance->pushHandler(($container->privates['monolog.handler.routes'] ?? self::getMonolog_Handler_RoutesService($container)));
        $instance->pushHandler(($container->privates['monolog.handler.main'] ?? self::getMonolog_Handler_MainService($container)));
    ...
    protected static function getSerializerService($container)
    {
        ...
        $e = new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $b, $c)], [$d]));

        $f = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer($e);
        $g = ($container->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_MetadataFactory_CachedService($container));
        ...
        $i = ($container->privates['api_platform.metadata.property.metadata_factory.cached.legacy'] ?? self::getApiPlatform_Metadata_Property_MetadataFactory_Cached_LegacyService($container));
        $j = ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], []));

        $k = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($g, $h, $i, ($container->privates['api_platform.hydra.json_schema.schema_factory'] ?? self::getApiPlatform_Hydra_JsonSchema_SchemaFactoryService($container)), ($container->privates['api_platform.json_schema.type_factory'] ?? self::getApiPlatform_JsonSchema_TypeFactoryService($container)), ($container->privates['api_platform.operation_path_resolver.router'] ?? self::getApiPlatform_OperationPathResolver_RouterService($container)), NULL, $j, NULL, false, 'oauth2', 'application', '', '', [], [], ($container->privates['api_platform.subresource_operation_factory.cached'] ?? self::getApiPlatform_SubresourceOperationFactory_CachedService($container)), true, 'page', false, 'itemsPerPage', $container->parameters['api_platform.formats'], false, 'pagination', [], $container->parameters['api_platform.swagger.versions'], ($container->privates['api_platform.identifiers_extractor.cached'] ?? self::getApiPlatform_IdentifiersExtractor_CachedService($container)), NULL, true, $e));
        ...
        $o = ($container->privates['api_platform.iri_converter.legacy'] ?? $container->load('getApiPlatform_IriConverter_LegacyService'));
        $p = ($container->privates['api_platform.jsonld.context_builder'] ?? self::getApiPlatform_Jsonld_ContextBuilderService($container));
        $q = ($container->privates['api_platform.serializer.mapping.class_metadata_factory'] ?? self::getApiPlatform_Serializer_Mapping_ClassMetadataFactoryService($container));
        ...
        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), $f, $k, new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($l, [], $m), new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $m), $k, $f, new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($g, $h, $i, $n, NULL, $l, NULL, $m), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($g, $o, $l), new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($l, true), new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($g, $h, $i, $o, $n, $p, $b, $m, $q, [], new RewindableGenerator(fn () => new \EmptyIterator(), 0), $a), new \ApiPlatform\Serializer\ItemNormalizer($h, $i, $o, $n, $b, $m, $q, ($container->privates['debug.api_platform.item_data_provider'] ?? self::getDebug_ApiPlatform_ItemDataProviderService($container)), false, NULL, new RewindableGenerator(fn () => new \EmptyIterator(), 0), $g, $a), new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $m), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($p, $n, $o, NULL), 'page', 'pagination', $g, $b), $g, $n, $j), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($r, $o, $p), $r], [new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $d, new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), new \Symfony\Component\Serializer\Encoder\CsvEncoder(), new \ApiPlatform\Serializer\JsonEncoder('jsonld'), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
