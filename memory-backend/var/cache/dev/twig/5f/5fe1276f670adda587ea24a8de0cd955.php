...
class __TwigTemplate_29abbb89499bcc3db277a6bef1cd98a1 extends Template
{
    private $source;
    private $macros = [];
...
", "@DoctrineMigrations/Collector/icon-v3.svg", "/media/hdd/repos/web3/memory-backend/vendor/doctrine/doctrine-migrations-bundle/Resources/views/Collector/icon-v3.svg");
    }
}
